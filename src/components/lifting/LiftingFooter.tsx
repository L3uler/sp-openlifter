...
import { Entry, Flight, Language, Lift, LiftResultApiModel } from "../../types/dataTypes";
...
import postLiftResultToApi from "../../api/LiftResult";
...
interface OwnProps {
  ...
  handleRequestStateChange: (sendRequest: boolean, requestDelay: number) => void;
}
...
class LiftingFooter extends React.Component<Props> {
  ...
  handleDayChange = (event: React.BaseSyntheticEvent) => {
    ...
    this.handleSendAttempt(
      this.apiConfig.liftAttempt.dayDropdownChange.sendData,
      this.apiConfig.liftAttempt.dayDropdownChange.delay
    );
  };
  ...
  handlePlatformChange = (event: React.BaseSyntheticEvent) => {
    ...
    this.handleSendAttempt(
      this.apiConfig.liftAttempt.platformDropdownChange.sendData,
      this.apiConfig.liftAttempt.platformDropdownChange.delay
    );
  };
  ...
  handleFlightChange = (event: React.BaseSyntheticEvent) => {
    ...
    this.handleSendAttempt(
      this.apiConfig.liftAttempt.flightDropdownChange.sendData,
      this.apiConfig.liftAttempt.flightDropdownChange.delay
    );
  };
  ...
  handleLiftChange = (event: React.BaseSyntheticEvent) => {
    ...
    this.handleSendAttempt(
      this.apiConfig.liftAttempt.liftDropdownChange.sendData,
      this.apiConfig.liftAttempt.liftDropdownChange.delay
    );
  };
  ...
  handleAttemptChange = (event: React.BaseSyntheticEvent) => {
    ...
    this.handleSendAttempt(
      this.apiConfig.liftAttempt.attemptDropdownChange.sendData,
      this.apiConfig.liftAttempt.attemptDropdownChange.delay
    );
  };
  ...
  handleLifterChange = (event: React.BaseSyntheticEvent) => {
    ...
    this.handleSendAttempt(
      this.apiConfig.liftAttempt.lifterDropdownChange.sendData,
      this.apiConfig.liftAttempt.lifterDropdownChange.delay
    );
  };
  ...
  handleGoodLift = () => {
    ...
    this.handleSendAttempt(this.apiConfig.liftAttempt.goodLift.sendData, this.apiConfig.liftAttempt.goodLift.delay);

    if (this.apiConfig.liftResult.goodLift.sendData) {
      this.handleSendResult(true);
    }
  };
  ...
  handleNoLift = () => {
    ...
    this.handleSendAttempt(this.apiConfig.liftAttempt.noLift.sendData, this.apiConfig.liftAttempt.noLift.delay);

    if (this.apiConfig.liftResult.noLift.sendData) {
      this.handleSendResult(false);
    }
  };
  ...
  handleSendAttempt(sendRequest: boolean, requestDelay: number) {
    this.props.handleRequestStateChange(sendRequest, requestDelay);
  }

  handleSendResult(liftSuccessful: boolean) {
    const liftResult: LiftResultApiModel = {
      liftSuccessful: liftSuccessful,
    };
    postLiftResultToApi(liftResult);
  }
    ...
    return (
      <div className={styles.footer}>
        <div className={styles.leftControls}>
          <button onClick={() => this.handleSendAttempt(true, 0)} className={styles.postlifter}>
            <FormattedMessage id="lifting.button-send-to-overlay" defaultMessage="Send To Overlay" />
          </button>
          <Form.Control
            as="select"
