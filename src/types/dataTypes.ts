...
// Model used for sending lift attempt data to overlay API.
export type LiftAttemptApiModel = {
  competitionName: string;
  lifter: Entry;
  liftCode: Lift;
  weightUnit: string;
  lifterWeightClass: string;
};

export type LiftResultApiModel = {
  liftSuccessful: boolean;
};
